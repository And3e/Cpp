...
void enter(int &sel, int &mod, int &lev, bool &startg, int &music, int &sound, int &theme){
  string s="   ", s2="    ";
  string sr1="                                                                    ";
  string sr2="                                                                         ";
  string sr3="                                                               ";
...
void menu(int &mod, int &lev, int &music, int &sound, int &theme){
  int sel=0;
  char in;
  ...
  if(in==13){
    enter(sel, mod, lev, startg, music, sound, theme);
    if(startg==true){
      goto enter;
    }
    else{
...
void game(int mod, int lev, int music, int sound, int theme){
  char m;
  int x, y, tempo=1, t, exit, up=0, down=0, right=0, left=0;
...
int main(){
  int mod=0, lev=1, music=1, sound=1, theme=0;
  bool r=true;
  srand(time(NULL));

  intro(r);
  menu:
    menu(mod, lev, music, sound, theme);
    PlaySound(NULL, 0, 0);
